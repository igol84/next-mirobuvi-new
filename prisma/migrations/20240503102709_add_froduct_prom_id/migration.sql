...
CREATE TABLE "new_Product" (
    ...
    "prom_id" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_Product" ("active", "brand_id", "color", "date", "id", "imgUpdatedAt", "is_available", "meta_desc_en", "meta_desc_ua", "name_en", "name_ua", "old_price", "price", "private", "prom_active", "prom_add_to_id", "prom_id", "season", "tags", "text_en", "text_ua", "title_en", "title_ua", "type", "url") SELECT "active", "brand_id", "color", "date", "id", "imgUpdatedAt", "is_available", "meta_desc_en", "meta_desc_ua", "name_en", "name_ua", "old_price", "price", "private", "prom_active", "prom_add_to_id", coalesce("prom_id", 0) AS "prom_id", "season", "tags", "text_en", "text_ua", "title_en", "title_ua", "type", "url" FROM "Product";
DROP TABLE "Product";
